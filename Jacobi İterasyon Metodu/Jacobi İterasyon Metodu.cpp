...
main(){
	...
	printf("\t\t\t               Jacobi Ýterasyon Metodu Programý\n");
...
void program(){
        system("cls");
    printf("\t| Jacobi Ýterasyon Metodu |\n");
    printf("\t|-------------------------------\n");
    ...
    for (int t = 1; t <= iterasyon ; t++) {
        ...
        xdeger[1][t] = (deger[1] - ((katsayilar[1][0] * xdeger[0][t - 1]) + (katsayilar[1][2] * xdeger[2][t - 1]))) / katsayilar[1][1];
        xdeger[2][t] = (deger[2] - ((katsayilar[2][0] * xdeger[0][t - 1]) + (katsayilar[2][1] * xdeger[2][t - 1]))) / katsayilar[2][2];
    }
